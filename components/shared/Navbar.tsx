                ...
                <div className="w-full md:w-2/5">
                    <div className="flex flex-col gap-8 md:gap-4">
                        <ul className="flex flex-row justify-between  md:gap-5 md:justify-end">
                            <li>
                                <Link href="https://www.linkedin.com/in/sahed-moral/" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                         data-supported-dps="24x24" fill="currentColor"
                                         className="h-16 w-16 text-[#0a66c2]" width="24" height="24" focusable="false">
                                        <path
                            ...
                            <li>
                                <Link href="https://github.com/sahedbs23" target="_blank">
                                    <svg height="64" aria-hidden="true" viewBox="0 0 16 16" version="1.1" width="64"
                            ...
                            <li>
                                <Link href="https://www.facebook.com/sahedsawon" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="64" height="64"
                                         viewBox="0 0 48 48">
