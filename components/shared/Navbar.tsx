...
import ActiveMenuIcon from "@/components/shared/ActiveMenuIcon";
...
const Navbar = () => {
    ...
    return (
        <header id="simple-header" className="flex flex-col md:flex-row p-4 mx-4 my-5 text-center md:text-left">
            ...
            <div className="w-full md:w-2/5">
                <div className="flex flex-col gap-5">
                    ...
                    <ul className="flex flex-col md:flex-row justify-between  md:gap-5 md:justify-end text-2xl ">
                        <li><Link className="text-2xl text-indigo-900" href="/projects">Projects</Link></li>
                        <li><Link className="text-2xl text-indigo-900" href="/experience">Experience</Link></li>
                        <li><Link className="text-2xl text-indigo-900" href="/contact">Resume</Link></li>
                    </ul>
                </div>
